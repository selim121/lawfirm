            ...
            <div className="max-w-screen-xl mx-auto py-12">
                ...
                <div className="flex flex-col justify-center items-center gap-4 lg:gap-20 pt-12">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-4 lg:gap-20">
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">01</p>
                        </div>
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">02</p>
                        </div>
                    </div>
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-4 lg:gap-20">
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">03</p>
                        </div>
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">04</p>
                        </div>
                    </div>
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-4 lg:gap-20">
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">05</p>
                        </div>
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">06</p>
                        </div>
                    </div>
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-4 lg:gap-20">
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">07</p>
                        </div>
                        <div className="relative p-16 bg-[#38102f] bg-shadow">
                            ...
                            <p className="text-white opacity-60 absolute top-5 right-5">08</p>
                        </div>
                    </div>
                </div>
            </div>
