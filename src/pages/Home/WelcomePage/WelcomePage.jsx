        ...
        <div id='welcome' className='bg-[#1F2732]'>
            <div className="max-w-screen-xl mx-auto py-12 px-4">
                ...
                <div className="flex flex-col lg:flex-row items-center px-4 mt-20">
                    <div data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className='card-bg bg-[#161D27] w-full md:w-1/3 p-4 rounded-lg mb-8 lg:mb-0 md:me-8'>
                    ...
                    <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className="text-white 'w-full md:w-2/3 px-4">
                ...
                <div className="card-bg p-4 bg-[#161D27] my-36 relative ">
                    ...
                    <div className="flex flex-col lg:flex-row items-center p-4 bg-[#1F2732]">
                        <div data-aos="zoom-in" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className='card-bg bg-[#161D27] p-4 rounded-full my-8 lg:my-0 lg:me-8'>
                        ...
                        <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className="p-4">
                ...
                <div className="bg-img bg-fixed">
                    <div className="flex flex-col h-screen items-center justify-center px-4">
                        <div data-aos="flip-up" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className="bg-[#1F2732] w-full md:w-[500px] lg:w-[800px] p-8 md:p-12 lg:p-16">
                ...
                <div className="">
                    <div className="flex flex-col lg:flex-row items-center mt-20">
                        <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className='card-bg bg-[#161D27] w-full md:w-1/3 p-4 rounded-lg mb-8 lg:mb-0 md:me-8'>
                            <div className="relative w-full h-full overflow-hidden rounded-lg">
                        ...
                        <div data-aos="fade-down" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className="text-white 'w-full md:w-2/3">
                ...
                <div className="">
                    <div className="flex flex-col-reverse lg:flex-row items-center mt-20">
                        <div data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className="text-white 'w-full md:w-2/3 px-4">
                        ...
                        <div data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="1000" data-aos-anchor-placement="center-bottom" className='card-bg bg-[#161D27] w-full md:w-1/3 p-4 rounded-lg mb-8 lg:mb-0 md:ms-8'>
                            <div className="relative w-full h-full overflow-hidden rounded-lg">
